...
## Rede Local — 192.168.68.0/24 · SSID: XIMBICA (TP-Link Deco Mesh)

| IP | Nome | Device | Conexão | Role |
|---|---|---|---|---|
...
| .103 | MacBookPro | MacBook Pro M1 | Wi-Fi 5G | Field · mobile · ⏳ pendente VPN |
...
| .108 | HP6F8240 | HP DeskJet 3755 | Wi-Fi 2.4G | Impressora |
| .110 | iRobot | Roomba | Wi-Fi 2.4G | Aspirador |
